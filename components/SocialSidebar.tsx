  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="fixed bottom-0 left-8 z-40 hidden lg:flex flex-col items-center gap-5"
      >
      ...
      {/* Right sidebar — rotated email */}
      <motion.div
        initial={{ opacity: 0, x: 20 }}
        animate={{ opacity: 1, x: 0 }}
        transition={{ delay: 1.2, duration: 0.5 }}
        className="fixed bottom-0 right-8 z-40 hidden lg:flex flex-col items-center gap-5"
      >
        <motion.a
